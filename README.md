...
<p align="center">
  <img src="YOUR_SCREENSHOT_URL_HERE" width="700" alt="App Preview">
</p>

This project demonstrates how to build a high-performance Pokémon filtering application using **WPF, Entity Framework Core, and PostgreSQL**. It includes a full data orchestration pipeline that migrates data from **PokéAPI** into a relational database.
